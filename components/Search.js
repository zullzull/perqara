...
import Sugggestions from "./Suggestion";
   ...
   return (
      <div className="relative w-full">
         <div className="relative w-full">
            ...
            <input onChange={doSearch} type="text" className="h-9 border rounded w-full pl-10 bg-pq-primary border-pq-primary focus:ring-pq-primary focus:border-pq-primary focus-visible:ring-pq-primary focus-visible:border-pq-primary focus-visible:outline-none  text-pq-gray" placeholder="Find movie"/>
