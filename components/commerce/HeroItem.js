      ...
      <div className={`flex relative ${isActive ? 'opacity-100' : 'opacity-50'}`}>
         ...
         <div className="my-5 flex-auto w-6/12 bg-black flex flex-col text-white">
            <div className="grid pr-5 py-6 pl-4 gap-y-3">
               <Rating score={7.3} size={16.2} mode="dark" />
               ...
               <div className="leading-[18px] text-xs">
                  When the crew of a space junk collector ship called The Victory discovers a humanoid robot named Dorothy that&sbquo;s known to be a weapon of mass destruction, they get involved in a risky business deal which puts their lives at stake.
               </div>
            </div>
         </div>
      </div>
